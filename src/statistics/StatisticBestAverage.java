...
public class StatisticBestAverage<E extends Individual, P extends Problem<E>> implements GAListener  {
    ...
    public void runEnded(GAEvent e) {
        ...
        catches[run] = ga.getBestInRun().getNumCatches();
    ...
    public void experimentEnded(ExperimentEvent e) {
        ...
        double avg_c = Maths.average(catches);
        double avg_it = Maths.average(sumIterations);
        
        utils.FileOperations.appendToTextFile("stats_results/statistic_average_fitness.xls", e.getSource() + "\tAVG FITNESS:" + average + "\tSD:" + sd + "\tAVG CATCH.:" + avg_c + "\tAVG ITER.:" + avg_it + "\r\n");
    }    
}
